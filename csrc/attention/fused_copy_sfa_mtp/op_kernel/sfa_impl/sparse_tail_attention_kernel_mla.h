...
template <typename SFAT> class CopySfaMtpAttentionMla {
public:
    using T = float;
    ...
    __aicore__ inline CopySfaMtpAttentionMla(){};
    __aicore__ inline void Init(__gm__ uint8_t *query, __gm__ uint8_t *key, __gm__ uint8_t *value,
                                ...
                                const CopySfaMtpAttentionTilingDataMla *__restrict tiling,
...
private:
    ...
    const CopySfaMtpAttentionTilingDataMla *__restrict tilingData = nullptr;
...
template <typename SFAT> __aicore__ inline void CopySfaMtpAttentionMla<SFAT>::InitTilingData()
{
...
template <typename SFAT> __aicore__ inline void CopySfaMtpAttentionMla<SFAT>::InitBuffers()
{
    if ASCEND_IS_AIV {
...
CopySfaMtpAttentionMla<SFAT>::InitActualSeqLen(__gm__ uint8_t *actualSeqLengthsQ,
...
template <typename SFAT>
__aicore__ inline void CopySfaMtpAttentionMla<SFAT>::InitAllZeroOutput(uint32_t bIdx, uint32_t s1Idx, uint32_t n2Idx)
{
...
template <typename SFAT>
__aicore__ inline void CopySfaMtpAttentionMla<SFAT>::InitOutputSingleCore()
{
...
template <typename SFAT>
__aicore__ inline void CopySfaMtpAttentionMla<SFAT>::GetActualSeqLen(uint32_t bIdx, uint32_t s1Idx)
{
    (void)s1Idx;
...
template <typename SFAT>
__aicore__ inline uint64_t CopySfaMtpAttentionMla<SFAT>::GetTopKRowOffset(uint32_t bIdx, uint32_t s1Idx,
                                                                           uint32_t n2Idx)
{
    (void)n2Idx;
    if constexpr (MTP_MODE) {
...
template <typename SFAT>
__aicore__ inline void CopySfaMtpAttentionMla<SFAT>::GetSparseActualSeqLen(uint32_t bIdx, uint32_t s1Idx,
                                                                            uint32_t n2Idx)
{
    (void)n2Idx;
...
template <typename SFAT>
__aicore__ inline uint32_t CopySfaMtpAttentionMla<SFAT>::GetActualSeqLenKV(uint32_t bIdx)
{
    if constexpr (KV_LAYOUT_T == SFA_LAYOUT::TND) {
        if (bIdx > 0) {
...
template <typename SFAT>
__aicore__ inline void CopySfaMtpAttentionMla<SFAT>::DealActSeqLenIsZero(uint32_t bIdx, uint32_t s1Idx, uint32_t n2Idx)
{
    if ASCEND_IS_AIV {
...
template <typename SFAT>
__aicore__ inline void CopySfaMtpAttentionMla<SFAT>::GetPreNextTokensLeftUp()
{
...
template <typename SFAT> __aicore__ inline void CopySfaMtpAttentionMla<SFAT>::UpdateInnerLoopCond()
{
...
template <typename SFAT>
__aicore__ inline void CopySfaMtpAttentionMla<SFAT>::UpdateInner(uint32_t &s2End, uint32_t &curS2End,
...
template <typename SFAT>
__aicore__ inline void CopySfaMtpAttentionMla<SFAT>::Init(__gm__ uint8_t *query,
...
template <typename SFAT>
__aicore__ inline void
CopySfaMtpAttentionMla<SFAT>::InitSourceAwareGather(
    __gm__ uint8_t *dramKeyRope, __gm__ uint8_t *dramKey,
    __gm__ uint8_t *dramBlockTable, __gm__ uint8_t *sourceTokenIds,
    __gm__ uint8_t *copyCounts, uint32_t copyCap,
    uint32_t dramMaxBlockNum)
...
template <typename SFAT> __aicore__ inline void CopySfaMtpAttentionMla<SFAT>::InitCalcParamsEach()
{
...
template <typename SFAT>
__aicore__ inline void
CopySfaMtpAttentionMla<SFAT>::Bmm2DataCopyOut(uint64_t attenOutOffset, LocalTensor<OUT_T> &attenOutUb,
...
template <typename SFAT>
__aicore__ inline void CopySfaMtpAttentionMla<SFAT>::CalcParams(uint32_t loop, uint64_t s2Start,
...
template <typename SFAT>
__aicore__ inline void CopySfaMtpAttentionMla<SFAT>::ComputeMm1(const RunInfo &info)
{
...
template <typename SFAT>
__aicore__ inline void CopySfaMtpAttentionMla<SFAT>::ComputeMm2(const RunInfo &info)
{
    uint32_t nBufferLoopTimes = (info.actMBaseSize + constInfo.nBufferMBaseSize - 1) / constInfo.nBufferMBaseSize;
    uint32_t nBufferTail = info.actMBaseSize - (nBufferLoopTimes - 1) * constInfo.nBufferMBaseSize;
    for (uint32_t i = 0; i < nBufferLoopTimes; i++) {
...
template <typename SFAT> __aicore__ inline void CopySfaMtpAttentionMla<SFAT>::Process()
{
    if (aiCoreIdx < usedCoreNum) {
        if ASCEND_IS_AIV {
...
template <typename SFAT>
__aicore__ inline void CopySfaMtpAttentionMla<SFAT>::GetBN2Idx(uint32_t bN2Idx, uint32_t &bIdx,
                                                                                uint32_t &n2Idx)
{
...
template <typename SFAT> __aicore__ inline void CopySfaMtpAttentionMla<SFAT>::ProcessBalance()
{
...
template <typename SFAT>
__aicore__ inline void
CopySfaMtpAttentionMla<SFAT>::PreloadPipeline(uint32_t loop, uint64_t s2Start, uint64_t s2LoopIdx,
                                                               RunInfo extraInfo[SFA_PRELOAD_TASK_CACHE_SIZE], uint32_t &curTopKIdx, uint64_t &curOffsetInSparseBlock)
{
...
CopySfaMtpAttentionMla<SFAT>::GetBalanceActualSeqLengths(GlobalTensor<int32_t> &actualSeqLengths,
                                                                          uint32_t bIdx)
{
    if constexpr (MTP_MODE) {
        const uint32_t queryBegin = bIdx == 0
...
template <typename SFAT>
__aicore__ inline void CopySfaMtpAttentionMla<SFAT>::GetAxisStartIdx(uint32_t bN2EndPrev,
                                                                                      uint32_t s1GEndPrev,
                                                                                      uint32_t s2EndPrev)
{
...
template <typename SFAT>
__aicore__ inline void CopySfaMtpAttentionMla<SFAT>::CalcSinnerTopKBegin(RunInfo &info, uint32_t &curTopKIdx, uint64_t &curOffsetInSparseBlock)
