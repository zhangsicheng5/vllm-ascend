...
static ge::graphStatus InferShapeFusedQuantLightningIndexerManage(gert::InferShapeContext *context)
{
    OPS_ERR_IF(context == nullptr,
               OPS_LOG_E("FusedQuantLightningIndexerManage",
...
static ge::graphStatus InferDataTypeFusedQuantLightningIndexerManage(gert::InferDataTypeContext *context)
{
    OPS_ERR_IF(context == nullptr,
               OPS_LOG_E("FusedQuantLightningIndexerManage",
...
IMPL_OP_INFERSHAPE(FusedQuantLightningIndexerManage)
    .InferShape(InferShapeFusedQuantLightningIndexerManage)
    .InferDataType(InferDataTypeFusedQuantLightningIndexerManage);
} // namespace ops
