...
/*!
 * \file fused_quant_lightning_indexer_manage_common.h
 * \brief
 */
#ifndef FUSED_QUANT_LIGHTNING_INDEXER_MANAGE_COMMON_H
#define FUSED_QUANT_LIGHTNING_INDEXER_MANAGE_COMMON_H
...
#endif // FUSED_QUANT_LIGHTNING_INDEXER_MANAGE_COMMON_H
