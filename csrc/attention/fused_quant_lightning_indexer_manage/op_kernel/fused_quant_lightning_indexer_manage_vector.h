...
/*!
 * \file fused_quant_lightning_indexer_manage_vector.h
 * \brief
 */
#ifndef FUSED_QUANT_LIGHTNING_INDEXER_MANAGE_VECTOR_H
#define FUSED_QUANT_LIGHTNING_INDEXER_MANAGE_VECTOR_H
                               ...
                               int64_t groupInner, int64_t s2Inner, int32_t outerGidx)
{
    ...
    AscendC::Brcb(tmpBuff, weightsUb, LIMtpC8Common::CeilDiv(groupInner, static_cast<int64_t>(B32_BLOCK_ALIGN_NUM)),
...
#endif // FUSED_QUANT_LIGHTNING_INDEXER_MANAGE_VECTOR_H
