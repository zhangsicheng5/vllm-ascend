...
#include "fused_li_manage_mtp_c8_template_tiling_key.h"
#include "fused_li_manage_mtp_c8_kernel.h"
#include "fused_li_manage_mtp_c8_union.h"
...
#define LI_MTP_C8_COPY_TILING()                                                                                           \
    GET_TILING_DATA_WITH_STRUCT(FusedLiManageMtpC8TilingData, tiling_data_in, tiling);                                      \
    const FusedLiManageMtpC8TilingData *__restrict tiling_data = &tiling_data_in
...
template <int DT>
__global__ __aicore__ void fused_li_manage_mtp_c8(
