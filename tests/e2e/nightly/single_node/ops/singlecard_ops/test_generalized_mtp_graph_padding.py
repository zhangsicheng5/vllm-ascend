...
from vllm_ascend.distributed.kv_transfer.sparse_kv_offload.generalized_mtp_graph import MtpGraphBuffers
...
def test_padded_rows_generate_no_host_transfers_on_graph_replay(registered_pool, query_width):
    ...
    for count, reset in ((4, False), (3, False), (1, False), (4, True), (4, False)):
