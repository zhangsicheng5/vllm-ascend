...
Find more details [<u>here</u>](https://docs.vllm.ai/projects/ascend/en/v0.13.0/user_guide/support_matrix/supported_features.html).
...
Yes, vllm-ascend supports Prefill Disaggregation feature with Mooncake backend. Take [official tutorial](https://docs.vllm.ai/projects/ascend/en/v0.13.0/tutorials/pd_disaggregation_mooncake_multi_node.html) for example.
