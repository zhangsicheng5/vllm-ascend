...
class AscendCommonAttentionMetadata(CommonAttentionMetadata):
    ...
    # Sparse KV Cache offload related metadata
    ...
    # Flattened per-token request_id for spec decode usage.
    flattened_req_ids_tensor: torch.Tensor | None = None
    # Stable (verified) seq_len while spec decode is enabled,
    # unstable (draft) tokens should not participate in cache reuse since they might be refused and updated.
    ...
    def unpadded(self, num_actual_tokens: int, num_actual_reqs: int) -> "AscendCommonAttentionMetadata":
        ...
        return AscendCommonAttentionMetadata(
            ...
            flattened_req_ids_tensor=self.flattened_req_ids_tensor,
            stable_prefix_lens=self.stable_prefix_lens,
        )
