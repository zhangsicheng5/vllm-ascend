    ...
    def __post_init__(self) -> None:
        ...
        if long_sequence_enable():
            if self.enable_sequence_parallel:
                self.model_len_per_sp_cp = self.max_model_len // self.context_parallel_size // self.tensor_parallel_size
            else:
                self.model_len_per_sp_cp = self.max_model_len // self.context_parallel_size
        else:
            self.model_len_per_sp_cp = self.max_model_len
        if (self.max_num_batched_tokens < self.model_len_per_sp_cp
